...
const ExclusiveOffers = () => {
  return (
    <div
      className="flex flex-col items-center px-6 md:px-16 lg:px-24 x;:px32
     pt-20 pb-30"
    >
      <div className="flex flex-col md:flex-row items-center justify-between w-full">
        <Title
          ...
          subTitle={
            "Take advantage of our limited0time offers and special packages to enhance your stay and create unforgettable memories."
          }
        />
